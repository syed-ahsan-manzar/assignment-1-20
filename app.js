document.write("Assignment # 1(ALERTS):" + "<br>"); /* chapter # 01 of book */
console.log("Assignment # 1(ALERTS):" + "<br>"); /* chapter # 01 of book */
...
document.write("Assignment # 2(VARIABLES FOR STRINGS):" + "<br>"); /* chapter # 02 of book */
console.log("Assignment # 2(VARIABLES FOR STRINGS):" + "<br>"); /* chapter # 02 of book */
...
console.log("Assignment # 3(VARIABLES FOR NUMBERS):"); /* chapter # 03 of book */
...
console.log("Assignment # 4(VARIABLE NAMES: LEGAL & ILLEGAL):"); /* chapter # 04 of book */
document.write("Assignment # 4(VARIABLE NAMES: LEGAL & ILLEGAL):" + ",br>"); /* chapter # 04 of book */

var name1 = "syed",name2 = "ahsan",name3 = "manzar."; /*Question 01 */
...
document.write("Assignment # 5(MATH EXPRESSION):" + '<br>'); /* chapter # 05 of book */
...
document.write("you will need " + need + " chocolate chip to last  you untill the ripe old age of " + maximumAge + "<br>");

console.log("Assignment # 6-9(MATH EXPRESSION):"); /* chapter # 06-09 of book */
document.write("Assignment # 6-9(MATH EXPRESSION):" + "<br>"); /* chapter # 06-09 of book */
...
console.log("Assignment # 9-11(MATH EXPRESSION):"); /* chapter # 09-11 of book */
document.write("Assignment # 9-11(MATH EXPRESSION):" + "<br>"); /* chapter # 09-11 of book */
...
document.write("Assignment # 12-13(MATH EXPRESSION):" + "<br>"); /* chapter # 12-13 of book */
...
console.log("Assignment # 14-16(Arrays):"); /* chapter # 14-16 of book */
console.log("Assignment # 17-20(Arrays and Loop):"); /* chapter # 17-20 of book */